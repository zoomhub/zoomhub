...
CREATE INDEX content_activeAt_DESC_index ON content (activeAt DESC);
CREATE INDEX content_completedAt_index ON content (completedAt);
CREATE INDEX content_hashId_index ON content (hashId);
CREATE INDEX content_initializedAt_DESC_index ON content (initializedAt DESC);
CREATE INDEX content_numViews_DESC_index ON content (numViews DESC);
